...
class ServerHelper{
	...
	buildNewsApi(appServer){
		...
		appServer.get('/api/news', function(req, res){
			res.send(news);
		});

		appServer.get('/api/news/random', function(req, res){
			var index= Math.floor( Math.random() * news.length );
			res.send(news[index]);			
		});

		appServer.delete('/api/news/:newsId', function(req, res){
		...
		appServer.post('/api/news/like/:newsId', function(req, res){
		...
		appServer.post('/api/news', function(req, res){
	...
	buildAuthentication(appServer){
		...
		appServer.post('/api/login', function(req, res){
	...
	buildCatalog(appServer){
		...
		appServer.get('/api/catalog', function(req, res){
			res.send(catalog);
		});


		appServer.get('/api/catalog/:productId', function(req, res){
